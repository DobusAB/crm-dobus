...
exports.default = {
  data: function data() {
    return {
      ...
      cityOptions: [{ text: 'Halmstad', value: 'Halmstad' }, { text: 'Malmö', value: 'Malmö' }, { text: 'Göteborg', value: 'Göteborg' }],
      selectedIndustry: 'Frisör',
      industryOptions: [{ text: 'Frisör', value: 'Frisör' }, { text: 'Webb', value: 'Webb' }, { text: 'Tandläkare', value: 'Tandläkare' }]
    };
  },
