...
exports.default = {
  data: function data() {
    return {
      ...
      cityOptions: [{ text: 'Halmstad', value: 'Halmstad' }, { text: 'Falkenberg', value: 'Falkenberg' }, { text: 'Varberg', value: 'Varberg' }, { text: 'Kungsbacka', value: 'Kungsbacka' }, { text: 'Båstad', value: 'Båstad' }, { text: 'Laholm', value: 'Laholm' }, { text: 'Malmö', value: 'Malmö' }, { text: 'Göteborg', value: 'Göteborg' }, { text: 'Halland', value: 'Halland' }],
      selectedIndustry: 'Frisör',
      industryOptions: [{ text: 'Frisör', value: 'Frisör' }, { text: 'Webb', value: 'Webb' }, { text: 'Tandläkare', value: 'Tandläkare' }, { text: 'Bilförsäljning', value: 'Bilförsäljning' }, { text: 'Reklam', value: 'Reklam' }, { text: 'Marknadsföring', value: 'Marknadsföring' }, { text: 'Bygg', value: 'Bygg' }, { text: 'Mäklare', value: 'Mäklare' }, { text: 'Fastighet', value: 'Fastighet' }, { text: 'Café', value: 'Café' }, { text: 'Restaurang', value: 'Restaurang' }, { text: 'Underhållning', value: 'Underhållning' }]
    };
  },
  ...
  methods: {
    ...
    showDetail: function showDetail(lead) {
    ...
    phoneNumberIsEmpty: function phoneNumberIsEmpty(item) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-2f44e5c7", module.exports)
  } else {
    hotAPI.update("_v-2f44e5c7", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
...
},{"./components/dashboard/index.vue":7,"vue":5,"vue-resource":3,"vue-router":4}]},{},[8]);
